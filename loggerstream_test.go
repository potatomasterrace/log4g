...
func TestLoggerStream(t *testing.T) {
	...
	expectedCalls := []loggerCall{
		loggerCall{level: "[ERROR]",
			values: []interface{}{"Wed, 28 Nov 2018 23:18:15 CET", "prepend", "hello world", "1", "append"}},
		loggerCall{level: "[INFO] ",
			values: []interface{}{"Wed, 28 Nov 2018 23:18:15 CET", "prepend", "hello world", "2", "append"}},
		loggerCall{level: "[TRACE]",
			values: []interface{}{"Wed, 28 Nov 2018 23:18:15 CET", "prepend", " -> _/Users/redabourial/Documents/GitHub/log4g.testFunction :", "func1Arg2", "func1Arg1", " -> _/Users/redabourial/Documents/GitHub/log4g.testFunction2 :", "func2Arg2", "func2Arg1", "hello world", "3", "append"}}}
